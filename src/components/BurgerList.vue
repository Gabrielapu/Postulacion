...
<div>
    ...
    <b-modal id="my-modal" title="Eliminar" ok-title="Si" cancel-title="No" ok-variant="danger" cancel-variant="outline-success" @ok="deleteBurguer()">Seguro que desea eliminar {{this.nombreProducto}}?</b-modal>
    ...
    <table class="table table-bordered table-hover mt-4">
        ...
        <tbody>
            <tr v-for="burger in burgers" :key="burger._id">
                ...
                <td>
                    <button type="button" class="btn btn-primary mr-2 mb-1" @click="showDetails(burger._id)">Detalles</button>
                    <button type="button" class="btn btn-info mr-2 mb-1" @click="editBurger(burger._id)">Editar</button>
